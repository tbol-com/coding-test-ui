  ...
  return (
    <div className="fetchDescription">
      ...
      <p>
        {" "}
        See the{" "}
        <a className="link" href="https://rickandmortyapi.com/documentation/#rest" target="_blank" rel="noreferrer">
          documentation here.
        </a>{" "}
      </p>
      <p>
        Choose a way to display the characters. For each character show the <b>image, name, origin name, location name</b> and <b>episodes count</b>.
      </p>
      <p>
        Use the <b>src/components/tests/Fetch/Fetch.tsx</b> component. It's displayed on the right side.
      </p>
    </div>
  );
};
